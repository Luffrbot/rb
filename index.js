...
const _leveling = JSON.parse(fs.readFileSync('./bot/leveling.json'))
const _level = JSON.parse(fs.readFileSync('./bot/level.json'))

            + 'VERSION:3.0\n' 
            + 'FN:Affis Admin\n' 
            + 'ORG: Pengembang XBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=5511910622412:+55 11 91062-2412\n' 
            + 'END:VCARD' 
prefix = '.'
blocked = []          
